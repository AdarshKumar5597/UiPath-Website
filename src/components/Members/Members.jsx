...
const Members = () => {
  return (
    <>
      <div className='min-h-[30vh] min-w-[1080px] overflow-x-clip bg-[#fedad3]'>
        <Navbar />
      ...
      {/* Contents of card */}
      <div className='min-h-[100vh] grid lg:grid-cols-3 md:grid-cols-1 lg:gap-3 flex justify-items-center sm:justify-center md:justify-center'>
        {LeadData.map((lead) => (
